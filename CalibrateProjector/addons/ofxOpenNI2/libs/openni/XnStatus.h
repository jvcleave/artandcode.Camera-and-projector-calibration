 ...
 */
XN_C_API const XnChar* xnGetStatusString(const XnStatus Status_);
...
*/
XN_C_API const XnChar* xnGetStatusName(const XnStatus Status_);
...
*
*/
XN_C_API void xnPrintError(const XnStatus Status_, const XnChar* csUserMessage);
